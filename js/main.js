...
boca = document.querySelector('#boca')
eye01 = document.querySelector('#eye01')
eye02 = document.querySelector('#eye02')
palavras_possiveis = [
    {
        palavra: "COMPUTADOR",
        dica: "objeto",
...
function desenha_boneco(qnt_erros) {
    switch (qnt_erros) {
        case 1:
            ...
            eye01.style.height = '5px'
            eye01.style.width = '5px'
            eye02.style.height = '5px'
            eye02.style.width = '5px'
            boca.style.height = '2px'
            return;
        case 2:
            corpo.style.visibility = "visible";
            eye01.style.height = '6px'
            eye01.style.width = '6px'
            eye02.style.height = '6px'
            eye02.style.width = '6px'
            boca.style.height = '4px'
            return;
        case 3:
            braco_01.style.visibility = "visible";
            eye01.style.height = '7px'
            eye01.style.width = '7px'
            eye02.style.height = '7px'
            eye02.style.width = '7px'
...
function setLetrasUsadas(chute) {
    ...
    let container_letras_usadas = document.getElementById(
        "container-letras-usadas"
    );
